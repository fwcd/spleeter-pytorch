...
def main():
    ...
    parser.add_argument('--torch-istft', default=True, action=argparse.BooleanOptionalAction, help="Whether to use PyTorch's native inverse STFT.")
    ...
    estimator = Estimator(
        ...
        use_torch_istft=args.torch_istft,
    )
    estimator.eval()
